 ...
 * {@link org.springframework.core.annotation.MergedAnnotation MergedAnnotations}.
 *
 * @author Phillip Webb
 * @since 5.2
 */
public abstract class MergedAnnotationPredicates {
	...
	/**
	 * {@link java.util.function.Predicate} implementation used for
	 * {@link org.springframework.core.annotation.MergedAnnotationPredicates#firstRunOf(java.util.function.Function)}.
	 */
	...
	/**
	 * {@link java.util.function.Predicate} implementation used for
	 * {@link org.springframework.core.annotation.MergedAnnotationPredicates#unique(java.util.function.Function)}.
	 */
	...
	/**
	 * Create a new {@link java.util.function.Predicate} that evaluates to {@code true} if the name of the
	 * {@linkplain org.springframework.core.annotation.MergedAnnotation#getType() merged annotation type} is contained in
	 * the specified array.
	 *
	 * @param <A>       the annotation type
	 * @param typeNames the names that should be matched
	 * @return a {@link java.util.function.Predicate} to test the annotation type
	 */
	...
	/**
	 * Create a new {@link java.util.function.Predicate} that evaluates to {@code true} if the
	 * {@linkplain org.springframework.core.annotation.MergedAnnotation#getType() merged annotation type} is contained in
	 * the specified array.
	 *
	 * @param <A>   the annotation type
	...
	/**
	 * Create a new stateful, single use {@link java.util.function.Predicate} that matches only
	 ...
	 * @return a {@link java.util.function.Predicate} that matches the first run of the extracted
	 * values
	 */
	...
	/**
	 * Create a new stateful, single use {@link java.util.function.Predicate} that matches
	 ...
	 *                     uniqueness
	 * @return a {@link java.util.function.Predicate} that matches a unique annotation based on the
	 * extracted key
	 */
