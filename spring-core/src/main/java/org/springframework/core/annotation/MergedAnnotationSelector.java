...
/**
 * Strategy interface used to select between two {@link org.springframework.core.annotation.MergedAnnotation}
 * instances.
 *
 * @param <A> the annotation type
 * @author Phillip Webb
 * @see org.springframework.core.annotation.MergedAnnotationSelectors
 * @since 5.2
 */
@FunctionalInterface
