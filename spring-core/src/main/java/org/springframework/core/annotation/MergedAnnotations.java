 ...
 * from a source such as a {@link Class} or {@link java.lang.reflect.Method}.
 *
 ...
 * </table>
 *
 * <p>{@link MergedAnnotations} can be obtained {@linkplain #from(java.lang.reflect.AnnotatedElement)
 * from} any Java {@link java.lang.reflect.AnnotatedElement}. They may also be used for sources that
 * don't use reflection (such as those that directly parse bytecode).
 *
 * <p>Different {@linkplain org.springframework.core.annotation.MergedAnnotations.SearchStrategy search strategies} can be used to locate
 * related source elements that contain the annotations to be aggregated. For
 * example, {@link org.springframework.core.annotation.MergedAnnotations.SearchStrategy#TYPE_HIERARCHY} will search both superclasses and
...
public interface MergedAnnotations extends Iterable<MergedAnnotation<Annotation>> {
	 ...
	 * {@link MergedAnnotations#from(java.lang.reflect.AnnotatedElement, org.springframework.core.annotation.MergedAnnotations.SearchStrategy)}.
	 *
	...
	enum SearchStrategy {
		 ...
		 * {@link java.lang.annotation.Inherited @Inherited} annotations and without searching
		 ...
		 * {@link java.lang.annotation.Inherited @Inherited} superclass annotations. This strategy
		 * is only really useful when used with {@link Class} types since the
		 * {@link java.lang.annotation.Inherited @Inherited} annotation is ignored for all other
		 * {@linkplain java.lang.reflect.AnnotatedElement annotated elements}. This strategy does
		 ...
		 * do not need to be meta-annotated with {@link java.lang.annotation.Inherited @Inherited}.
		 ...
		 * not need to be meta-annotated with {@link java.lang.annotation.Inherited @Inherited}.
		 */
		TYPE_HIERARCHY,
		 ...
		 * need to be meta-annotated with {@link java.lang.annotation.Inherited @Inherited}. When
		 * searching a {@link java.lang.reflect.Method} source, this strategy is identical to
		 * {@link #TYPE_HIERARCHY}.
		 */
	 ...
	 * {@link #from(java.lang.reflect.AnnotatedElement, org.springframework.core.annotation.MergedAnnotations.SearchStrategy)} with an appropriate
	 * {@link org.springframework.core.annotation.MergedAnnotations.SearchStrategy}.
	 *
	 ...
	 * depending on the {@link org.springframework.core.annotation.MergedAnnotations.SearchStrategy}, related inherited elements.
	 *
	 * @param element        the source element
	 ...
	 * @see #from(Object, java.lang.annotation.Annotation...)
	 */
	 ...
	 * @param annotations the annotations to include
	 * @return a {@link MergedAnnotations} instance containing the annotations
	 * @see #from(java.lang.annotation.Annotation...)
	 * @see #from(java.lang.reflect.AnnotatedElement)
	 */
