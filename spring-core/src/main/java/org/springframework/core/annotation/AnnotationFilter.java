 ...
 *
 * <p>Note that the {@link org.springframework.core.annotation.MergedAnnotations} model (which this interface has been
...
public interface AnnotationFilter {
	...
	/**
	 * {@link org.springframework.core.annotation.AnnotationFilter} that matches annotations in the
	 * {@code java.lang} and {@code org.springframework.lang} packages
	 * and their subpackages.
	 * <p>This is the default filter in the {@link org.springframework.core.annotation.MergedAnnotations} model.
	 */
	...
	/**
	 * {@link org.springframework.core.annotation.AnnotationFilter} that always matches and can be used when no
	...
	/**
	 * {@link org.springframework.core.annotation.AnnotationFilter} that never matches and can be used when no
	 * filtering is needed (allowing for any annotation types to be present).
	 *
	 * @see #PLAIN
	 * @deprecated as of 5.2.6 since the {@link org.springframework.core.annotation.MergedAnnotations} model
	...
	/**
	 * Create a new {@link org.springframework.core.annotation.AnnotationFilter} that matches annotations in the
	 * specified packages.
	 *
	 * @param packages the annotation packages that should match
	 * @return a new {@link org.springframework.core.annotation.AnnotationFilter} instance
	 */
