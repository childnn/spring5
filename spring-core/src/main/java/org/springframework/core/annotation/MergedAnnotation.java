...
public interface MergedAnnotation<A extends Annotation> {
	 ...
	 * {@linkplain MergedAnnotation#asMap(org.springframework.core.annotation.MergedAnnotation.Adapt...) Maps} or
	 * {@link MergedAnnotation#asAnnotationAttributes(org.springframework.core.annotation.MergedAnnotation.Adapt...) AnnotationAttributes}.
	 */
	enum Adapt {
		...
		/**
		 * Factory method to create an {@link org.springframework.core.annotation.MergedAnnotation.Adapt} array from a set of boolean flags.
		 *
		 * @param classToString    if {@link org.springframework.core.annotation.MergedAnnotation.Adapt#CLASS_TO_STRING} is included
		 * @param annotationsToMap if {@link org.springframework.core.annotation.MergedAnnotation.Adapt#ANNOTATION_TO_MAP} is included
		 * @return a new {@link org.springframework.core.annotation.MergedAnnotation.Adapt} array
		 */
	 ...
	 * or {@link java.lang.annotation.Inherited @Inherited}.
	 *
	 ...
	 * {@link java.lang.reflect.AnnotatedElement} then this source will be an element of the same
	 ...
	 * @see MergedAnnotationPredicates#unique(java.util.function.Function)
	 * @see #getRoot()
	 * @see #getMetaSource()
	 */
	 ...
	 * @throws java.util.NoSuchElementException if there is no matching attribute
	 */
	 ...
	 *
	 * @param attributeName the attribute name
	 * @return an optional value or {@link java.util.Optional#empty()} if there is no
	 * matching attribute
	 */
	 ...
	 *
	 * @param attributeName the attribute name
	 * @return an optional of the default value or {@link java.util.Optional#empty()} if
	 ...
	 * @see #filterAttributes(java.util.function.Predicate)
	 */
	 ...
	 * merged annotation.
	 * <p>The {@link org.springframework.core.annotation.MergedAnnotation.Adapt adaptations} may be used to change the way that values
	 * are added.
	 *
	...
	/**
	 * Get an immutable {@link java.util.Map} that contains all the annotation attributes.
	 * <p>The {@link org.springframework.core.annotation.MergedAnnotation.Adapt adaptations} may be used to change the way that values are added.
	 *
	 * @param adaptations the adaptations that should be applied to the annotation values
	 * @return an immutable map containing the attributes and values
	 */
	...
	/**
	 * Create a new {@link java.util.Map} instance of the given type that contains all the annotation
	 * attributes.
	 * <p>The {@link org.springframework.core.annotation.MergedAnnotation.Adapt adaptations} may be used to change the way that values are added.
	 *
	 ...
	 * <p>The result is synthesized using a JDK {@link java.lang.reflect.Proxy} and as a result may
	 * incur a computational cost when first invoked.
	 * <p>If this merged annotation was created {@linkplain #from(java.lang.annotation.Annotation) from}
	 ...
	 * unmodified
	 * @throws java.util.NoSuchElementException on a missing annotation
	 */
	 ...
	 * @see #of(java.lang.reflect.AnnotatedElement, Class, java.util.Map)
	 */
