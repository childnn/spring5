 ...
 * actual {@link java.lang.annotation.Annotation} instance where methods on the annotation instance
 * are {@linkplain org.springframework.util.ReflectionUtils#invokeMethod(java.lang.reflect.Method, Object) invoked} to extract
 * values. Equally, the source could be a simple {@link java.util.Map} with values
 * extracted using {@link java.util.Map#get(Object)}.
 *
...
final class TypeMappedAnnotation<A extends Annotation> extends AbstractMergedAnnotation<A> {
	...
	private TypeMappedAnnotation(AnnotationTypeMapping mapping, @Nullable ClassLoader classLoader,
								 ...
								 ValueExtractor valueExtractor,
								 int aggregateIndex, boolean useMergedValues,
