...
/**
 * {@link org.springframework.core.annotation.MergedAnnotationSelector} implementations that provide various options
 * for {@link org.springframework.core.annotation.MergedAnnotation} instances.
 *
 * @author Phillip Webb
 * @see org.springframework.core.annotation.MergedAnnotations#get(Class, java.util.function.Predicate, org.springframework.core.annotation.MergedAnnotationSelector)
 * @see org.springframework.core.annotation.MergedAnnotations#get(String, java.util.function.Predicate, org.springframework.core.annotation.MergedAnnotationSelector)
 * @since 5.2
 */
public abstract class MergedAnnotationSelectors {
	...
	/**
	 * {@link org.springframework.core.annotation.MergedAnnotationSelector} to select the nearest annotation.
	 */
	...
	/**
	 * {@link org.springframework.core.annotation.MergedAnnotationSelector} to select the first directly declared
	 * annotation.
	 */
