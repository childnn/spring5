...
/**
 * {@link org.springframework.core.type.AnnotationMetadata} created from a
 * {@link org.springframework.core.type.classreading.SimpleAnnotationMetadataReadingVisitor}.
 *
 * @author Phillip Webb
 * @author Sam Brannen
...
final class SimpleAnnotationMetadata implements AnnotationMetadata {
	...
	SimpleAnnotationMetadata(String className, int access, @Nullable String enclosingClassName,
							 ...
							 Set<String> memberClassNames, Set<MethodMetadata> declaredMethods,
