...
public abstract class CollectionUtils {
	...
	/**
	 * Instantiate a new {@link java.util.HashMap} with an initial capacity
	 * that can accommodate the specified number of elements without
	 * any immediate resize/rehash operations to be expected.
	 * <p>This differs from the regular {@link java.util.HashMap} constructor
	...
	/**
	 * Instantiate a new {@link java.util.LinkedHashMap} with an initial capacity
	 * that can accommodate the specified number of elements without
	 * any immediate resize/rehash operations to be expected.
	 * <p>This differs from the regular {@link java.util.LinkedHashMap} constructor
	...
	/**
	 * Retrieve the first element of the given Set, using {@link java.util.SortedSet#first()}
